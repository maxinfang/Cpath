...
$(document).ready(function () {
  ...
  console.log("Now reload page will start load mode of " + mode);
  ...
  jsPlumb.bind("Connection", function (info, originalEvent) {
    ...
    var parentId = $("#" + conn.sourceId)
      .parent()
      .attr("id");
    var childId = $("#" + conn.targetId)
      .parent()
      .attr("id");
    ...
    if (parentId != childId) {
      ...
      if (conn.getOverlays().length <= 1) {
        jsPlumb.select(conn).addOverlay([
          "Custom",
          {
